odoo.define('onpoint_seba.logger_realtime_dashboard', function (require) {
    "use strict";
    ...
    core.action_registry.add('onpoint_seba.logger_realtime_dashboard', OnpointLoggerRealtimeDashboard);
