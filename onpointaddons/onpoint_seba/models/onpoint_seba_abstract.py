...
class OnpointSeba(models.AbstractModel):
    ...
    def _process_block1(self, buffer=None):
        ...
        data['block1_current_logger_time'] = datetime.utcfromtimestamp(data['block1_current_logger_time']).strftime(
            '%Y-%m-%d %H:%M:%S')
        ...
        data['block1_ch1_set_water_counter'] = round(
            self._bin2float(str(bin(data['block1_ch1_set_water_counter'])).zfill(32)), 3)
        data['block1_ch2_set_water_counter'] = round(
            self._bin2float(str(bin(data['block1_ch2_set_water_counter'])).zfill(32)), 3)
        data['block1_ch3_set_water_counter'] = round(
            self._bin2float(str(bin(data['block1_ch3_set_water_counter'])).zfill(32)), 3)
        data['block1_ch4_set_water_counter'] = round(
            self._bin2float(str(bin(data['block1_ch4_set_water_counter'])).zfill(32)), 3)
        ...
        data['block1_ch1_set_unit_text'] = self._parse_units(data['block1_ch1_set_unit_id'],
                                                             data['block1_ch1_set_user_text'],
                                                             data['block1_ch1_set_flags'])
        data['block1_ch2_set_unit_text'] = self._parse_units(data['block1_ch2_set_unit_id'],
                                                             data['block1_ch2_set_user_text'],
                                                             data['block1_ch2_set_flags'])
        data['block1_ch3_set_unit_text'] = self._parse_units(data['block1_ch3_set_unit_id'],
                                                             data['block1_ch3_set_user_text'],
                                                             data['block1_ch3_set_flags'])
        data['block1_ch4_set_unit_text'] = self._parse_units(data['block1_ch4_set_unit_id'],
                                                             data['block1_ch4_set_user_text'],
                                                             data['block1_ch4_set_flags'])
        ...
        data['block1_ch1_set_corr_start_current'] = self._check_correction_value(
            data['block1_ch1_set_corr_start_current'])
        data['block1_ch2_set_corr_start_current'] = self._check_correction_value(
            data['block1_ch2_set_corr_start_current'])
        data['block1_ch3_set_corr_start_current'] = self._check_correction_value(
            data['block1_ch3_set_corr_start_current'])
        data['block1_ch4_set_corr_start_current'] = self._check_correction_value(
            data['block1_ch4_set_corr_start_current'])
