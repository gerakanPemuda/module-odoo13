odoo.define('onpoint_monitor.onpoint_dashboard', function (require) {
    "use strict";
    ...
    var OnpointDashboard = Widget.extend(ControlPanelMixin, {
        ...
        act_info: function(e) {
            ...
            self.do_action({
                ...
                tag: "onpoint_monitor.logger_dashboard",
                res_id: logger_id,
    ...
    core.action_registry.add('onpoint_monitor.onpoint_dashboard', OnpointDashboard);
