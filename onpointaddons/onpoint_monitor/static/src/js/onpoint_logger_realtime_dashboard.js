odoo.define('onpoint_monitor.logger_realtime_dashboard', function (require) {
    "use strict";
    ...
    core.action_registry.add('onpoint_monitor.logger_realtime_dashboard', OnpointLoggerRealtimeDashboard);
